...
def llm_call(question: str, context: list) -> AIResponse:
    if not context:
        return AIResponse(
        ...
        response = client.models.generate_content(
            ...
            config= types.GenerateContentConfig(
                ...
                system_instruction = """
                    ...
                    4. If the context does not contain enough information to answer the question, respond that as "no relevant answer was found.".
                    5. Do not use your own general knowledge.
                    6. Use only the id to cite don't fill out other fields, Only cite chunks that directly support the answer.
                """,
